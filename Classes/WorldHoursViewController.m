...
{
    if(DEVICE_IS_IPAD){
        WHMoreViewController *vc = [[WHMoreViewController alloc] 
                                    initWithNibName:@"WHMoreViewController_iPad" 
                                    bundle:nil];
    ...
    if(DEVICE_IS_IPHONE){
        WHMoreViewController *vc = [[WHMoreViewController alloc] 
                                    initWithNibName:@"WHMoreViewController" 
                                    bundle:nil];
    ...
    /*if (DEVICE_IS_IPAD){
        ...
        vc.view.superview.frame = CGRectMake(
                                             vc.view.superview.frame.origin.x,
                                             vc.view.superview.frame.origin.y,
                                             323.0f,
                                             353.0f
                                             );
